...
| 문서 범주 | 보관 개발 자료 |
| 파일 경로 | `Archive/Development/NightCaretaker_Complaint_Data_Mapping.md` |
...
| 1. 고정 매핑 규칙 | 주요 섹션 |
| 2. 추천 자산 경로 | 주요 섹션 |
| 3. Complaint Definition Mapping | 주요 섹션 |
...
| CMP_CH2_4F_CCTVBlank | 세부 기준 |
| 추가 섹션 35 개 | 원문 본문에서 이어서 확인한다. |
