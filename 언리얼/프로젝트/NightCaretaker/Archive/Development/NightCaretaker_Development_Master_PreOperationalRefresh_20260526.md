...
| 문서 범주 | 보관 개발 자료 |
| 파일 경로 | `Archive/Development/NightCaretaker_Development_Master_PreOperationalRefresh_20260526.md` |
...
| 중복 정리 기준 | 주요 섹션 |
| 빠른 구현 기준 | 주요 섹션 |
| 지금 이 프로젝트의 개발 방향 | 세부 기준 |
| 현재 가장 중요한 연결 작업 | 세부 기준 |
| 구현 시 계속 확인할 질문 | 세부 기준 |
| 개발 기획 및 범위 기준 | 주요 섹션 |
| 1. 문서 목적 | 세부 기준 |
| 2. 개발 핵심 원칙 | 세부 기준 |
| 3. 제품 목표 | 세부 기준 |
